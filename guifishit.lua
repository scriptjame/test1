...
-- remove old gui
local old = playerGui:FindFirstChild("FishItMenu")
...
-- scripts
createBtn("Arvyns Hub","https://api.arvynscripts.cloud/api/files/loader.lua")
createBtn("Meng Hub","https://menghub.dannnnbiasalah.workers.dev/")
createBtn("Fz Hub","https://raw.githubusercontent.com/ByStyvzz/Fish-It-BETA/refs/heads/main/README.md")
